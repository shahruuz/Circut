...
A complete step-by-step guide to get your CutSheet Co. e-commerce store on GitHub and deployed to the web.
...
3. Name it: `CutSheet Co.-Deployment`
...
# Create first commit
git commit -m "Initial commit: CutSheet Co. e-commerce store - full code ready"
```
...
2. Click **Add Domain**
3. Enter your domain (e.g., `cutsheetco.example`)
4. Click **Add**
...
Then visit `https://www.your-domain.com` 🎉
